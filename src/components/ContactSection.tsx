          ...
          >
            <Card className="p-8 bg-card/50 backdrop-blur border-primary/10">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Button
                  type="submit"
                  className="w-full bg-primary hover:bg-primary/90 text-background shadow-[0_0_30px_rgba(74,222,128,0.3)] hover:shadow-[0_0_50px_rgba(74,222,128,0.5)] transition-all duration-300"
                >
